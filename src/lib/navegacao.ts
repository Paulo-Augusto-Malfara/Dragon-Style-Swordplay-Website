...
export const menu: GrupoNav[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/introducao", label: "Equipamentos" },
...
const porGrupo: Record<string, string[]> = {
  Manual: [
    ...
    "mentor-de-classe", "bonus-nivel-3",
    "armas-curtas", "armas-medias", "armas-longas", "longo-alcance",
    "armas-de-arremesso", "escudos", "vestimentas", "tabela-de-equipamentos",
    "pontos-de-honra",
  ],
